 ...
 *
 */
@WebServlet("/main/pomain/pomainNew")
public class PomainNewServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)  {
		...
		try {
			...
			req.getRequestDispatcher("/main/pomain/pomain_layer.jsp").forward(req, resp);
		} catch (Exception e) {
