...
@WebServlet({"/main/pomain/pomainQueryDetail","/main/report/pomainQueryDetail"})
public class PomainQueryDetailServlet extends HttpServlet{
	private static final Logger LOGGER = Logger.getLogger(PomainQueryDetailServlet.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{
			...
			req.getRequestDispatcher("/main/pomain/pomain_query_detail.jsp").forward(req, resp);
		}catch(Exception e){
